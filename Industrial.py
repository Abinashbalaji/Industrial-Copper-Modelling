...
file_path_1 = r"C:\Users\ABINASH\Desktop\ABINASH DS\VS Code\Classification_model.pkl"
file_path_2 = r"C:\Users\ABINASH\Desktop\ABINASH DS\VS Code\Regression_Model.pkl"

def predict_status(country, item_type, application, width, product_ref, quantity_tons_log, customer_log,
                   thickness_log, selling_price_log, item_date_day, item_date_month, item_date_year,
    ...
    user_data = np.array([[country, item_type, application, width, product_ref, quantity_tons_log, customer_log,
                           thickness_log, selling_price_log, itdd, itdm, itdy, dydd, dydm, dydy]])
